      ...
      <main className="bg-insiderDark pb-24 pt-[80px]">
        ...
        <section className="w-full">
          <div className="container mx-auto max-w-6xl px-4 py-12">
            <h1 className="mb-8 text-center text-3xl font-bold text-gradient md:text-4xl lg:text-5xl">
              Sovereign Access
            </h1>
        ...
        <section className="w-full">
          <div className="container mx-auto max-w-5xl px-4 py-12">
            <h2 className="mb-8 text-center text-2xl font-bold text-gradient md:text-3xl">
            ...
            <div className="space-y-12">
              {[
                ...
                <Card key={index} className="glass-card overflow-hidden">
                  <CardContent className="p-0">
                    <h3 className="p-4 text-xl font-medium text-gradient">
                      {video.title}
                    </h3>
        ...
        <section className="w-full">
          <div className="container mx-auto max-w-5xl px-4 py-12">
            ...
            <div className="mt-12 text-center">
              <h3 className="mb-6 text-xl font-bold text-gradient">
