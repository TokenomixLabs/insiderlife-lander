  ...
  return (
    <section className="container mx-auto px-4 py-16 md:py-24 text-center">
      <div className="max-w-3xl mx-auto mb-12">
        <p className="text-2xl md:text-3xl font-semibold text-white/90">This isn't just another offer. It's the ignition of</p>
        <p className="text-2xl md:text-3xl font-semibold text-white/90">a Movement.</p>
